...
<image: "manual\_brake\_release\_switch.png">
...
## Things you will need
  ...
  * A Manual brake release switch for MiR250 from MiR

  * A torque wrench or screwdriver with the following exchangeable bits:
...
<image: "side\_unscrew.png">
  ...
  3. Turn the two screws counterclockwise on the side cover, and remove the cover from the robot. Use a T30 bit.
...
<image: "remove\_top\_cover\_no\_ends.png">

## Removing the corner bumper

  1. Remove the corner bumper from the robot, by unscrewing the four screws in the left-rear corner bumper. Use a T30 bit.

<image: "remove\_corener\_screws.png"> <image: "remove\_cornershield.png">

## Replacing the Manual brake release switch

  1. Remove the switch relay behind the switch by pressing in the pin on the side.

<image: "push\_lever.png"> <image: "remove\_relay.png">

  2. Unscrew the nut that keeps the switch in place. Remove and discard the old switch.

<image: "unscrew\_nut.png">

  3. Replace the old switch with the new one.

  4. Mount the switch relay to the new switch by pressing down the pin and putting the relay in place behind the switch.

  5. Reassemble the robot by following Replacing the Manual brake release switch in reverse.

## Testing

Turn on the robot and try to release the mechanical brakes by turning the Manual brake release switch clockwise. You should be able to push the robot when the brakes are released.

<image: "Brake\_release\_released.png">
 ...
 * 1.1
 * 2025-06-18
 * Corrected wrench size from 10 mm to 8 mm. Updated styling.
...
how-to\_troubleshooting/PDF/how\_to/replace/\_How to replace the Manual brake release switch on MiR250 1.0\_en.pdf