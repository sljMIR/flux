...
Document number: 300111

Order number: 450551, 450552, 450553, 450558, 450559, 450460
...
There are three different corner cover variations for both MiR600 and MiR1350. Check which corner cover you need to replace before ordering spare parts.

**Figure 1.2** Corner covers

<image: "corner_covers_spare_part_numbers.png">
...
*   T45 (HW 2.0 and higher)
        
*   T50 (HW 2.0 and higher)
        
*   A flat-head screwdriver

## Before replacing a corner cover

Turn off the robot. To turn off the robot, press and hold the Power button for three seconds.  

Depending on which corner cover you are replacing, identify the two covers to both sides of the corner, and remove them by following the relevant steps:

*   For the front cover, see [Accessing the front compartment](#Accessin).
    
*   For the rear cover, see [Removing the rear maintenance hatch](#Removing).
    
*   For either side cover, see [Removing the side compartment hatch](#Removing2).
...
1.  Press the two buttons on the rear hatch.
    ...
    <image: "access_rear_compartment_1.png">
    
2.  Pull open the hatch.
    
    <image: "access_rear_compartment_2.png">
...
Mount the new corner cover. Follow the steps in [Removing a corner cover](#Removing3) in reverse.

Reattach and close any removed hatches.

## Document history

how-to\_troubleshooting/PDF/how\_to/replace/\_How to replace the corner cover on MiR600 and MiR1350 1.0\_en.pdf