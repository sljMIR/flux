...
3. Unscrew the two bolts and washers keeping the fast swap levers raised. Use a 10 mm hex bit for the bolts and a 10 mm hex wrench  to keep the nuts in place.

    {% image src="/images/mir250/battery_charging/fast_swap_2_washers_screws.webp" alt="Remove washers and screws"  /%}

4. Pull the status light bracket down.

    {% image src="/images/mir250/battery_charging/fast_swap_3_move_status_light_bar.webp" alt="Pull handles down" /%}

5. Fasten the two levers to the battery lever using the same two bolts, washers, and nuts.

    {% image src="/images/mir250/battery_charging/fast_swap_4_attach_levers.webp" alt="Connect lavers to handle"  /%}