...
5. Remove the pallet collars and the protective foam blocks.
    ...
    {% image src="/images/mir250/packaging/remove_padding_shelf_carrier.webp" alt="The foam blocks being removed around the robot." /%}

6. Place the lid of the box so that you can use it as a ramp. Align the lid so that it is flush with the base of the box.

   {% image src="/images/mir250/packaging/place_ramp_shelf_carrier.webp" alt="The lid being placed as a ramp on the edge of the pallet with the robot. "  /%}

8. Screw on the two antennas.

   {% image src="/images/mir250/antenna/antenna_screw_on_shelf.webp" alt="An antenna being connected and screwed onto an antenna connector on the top compartment cover."  /%}