...
1.  Remove the two top screws, and loosen the two bottom screws on the right-rear cover. Use a T30 bit.
2.  Remove the cover.
3.  Connect each of the three batteries to their connectors.

    {% image src="/images/mir1200_pallet_jack/battery_charging/batteries_connected.webp" alt="Connect three batteries"  %}

4.  Reattach the right rear-cover.