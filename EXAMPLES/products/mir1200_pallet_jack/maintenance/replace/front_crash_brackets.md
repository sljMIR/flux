...
<image: "crash\_brackets\_isolate\_transparent.png">

# How to replace the front crash brackets on MiR250
...
## Things you will need
  ...
  * An 11.6 Nm torque wrench or screwdriver with the following exchangeable bits:
...
## Kit contents
  ...
  * 1 × Left crash bracket

  * 1 × Right crash bracket

## Before replacing the crash brackets
...
<image: "250\_mkII\_disconnect\_battery.png">
  ...
  3. Remove the two screws in the front cover, and remove the cover from the robot. Use a T30 bit.
...
## Replacing the crash brackets

  1. While holding the crash bracket, remove the two screws mounting the crash bracket to the robot chassis. Use a T30 bit, and save the screws.

<image: "crash\_bracket\_screws\_left.png">

  2. Remove the bracket, and replace it with a new bracket. The two brackets in the kit are mirrored; make sure to select the correct one for the chosen side.

<image: "crash\_bracket\_remove.png">

  3. Mount the new crash bracket in place using the same two screws. Tighten the screws to 11.6 Nm.

  4. Repeat step 1 to step 3 with the bracket on the other side.

  5. Reassemble the robot by following the steps in Before replacing the crash brackets in reverse.
...
how-to\_troubleshooting/PDF/how\_to/replace/\_How to replace the front crash brackets on MiR250 1.0\_en.pdf