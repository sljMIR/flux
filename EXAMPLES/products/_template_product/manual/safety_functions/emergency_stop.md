...
{% partial file="products/_manual_partials/product_properties/text_e-stop_box.md" /%}

{% partial file="products/_manual_partials/functions_features/text_auxiliary_emergency_stop.md" /%}
