# Speaker {% tag "replace_speaker_mir250" /%}

Date: 2025-07-21

Document version: 1.0

Document number: 300057
...
## Things you will need
  ...
  * A torque wrench ranging from 0.9 to 15 Nm with the following exchangeable bits:
...
## Replacing the speaker
  ...
  1. Remove the speaker and speaker cover in the front compartment by unscrewing the two screws. Use a T20 bit. Be careful not to damage any of the other cables or components in the front compartment.

<image: "remove\_speaker\_cover\_screws.png"> <image: "remove\_speaker\_cover.png">

  2. Once the speaker is released, disconnect the two cables.

<image: "remove\_cables.png">

  3. Remove the old speaker, and connect the cables to the new one. It does not matter which cable is connected to which connector.

<image: "attach\_cables.png">

  4. Push the speaker through the speaker hole. Make sure not to pinch any cables.

<image: "final\_setup.png">

  5. Mount the speaker cover to the new speaker by screwing in the two screws. Use a T20 bit. Tighten the screws to 0.9 Nm.

<image: "mount\_speaker\_cover\_screws.png">

  6. Remount the front cover and reconnect the battery.
 ...
 * 1.3
 * 2025-02-19
 * Simplified instructions. Updated styling.
 ...
 * 1.1
 * 2020-12-02
 * Corrections in how to remove the top cover. Added image of final speaker setup.
...
how-to\_troubleshooting/PDF/how\_to/replace/\_How to replace the speaker on MiR250 1.0\_en.pdf