...
{% image src="/images/mir600_1350/protective_fields/forward_field_sets.webp" alt="The forward field sets of the robot."  /%}

## Protective fields when driving backward

The Protective fields and cases are the same for the robot when it is driving in reverse.
